var timelineContentList = [
  ...
  },
  {
    ...
    time_en: "Jan 29, 2002",
    time_es: "",
    body_en: `In his 2002 State of the Union, he declared that Iraq and its terrorist allies constituted an “axis of evil” alongside North Korea and Iran.`,
    body_es: "Spanish body",
  ...
  },
  {
    ...
    time_en: "Feb 6, 2003",
    time_es: "",
    body_en: `At a U.N. Security Council meeting, Secretary of State Colin Powell presented contested evidence that the Iraqi government was stockpiling "Weapons of Mass Destruction"`,
    body_es: "Spanish body",
    caption_en: "Secretary Powell holds up a model vial of anthrax, one potential weapon of mass destruction he claims Iraq possesses.",
    caption_es: "Spanish caption",
  ...
  },
  {
    ...
    time_en: "Mar 20, 2003",
    time_es: "",
    body_en: `The Iraq War, also known as “Operation Iraqi Freedom,” formally began as the U.S. launched a “Shock and Awe” bombing campaign.`,
    body_es: "Spanish body",
  ...
  },
  {
    ...
    time_en: "Apr 14, 2003",
    time_es: "",
    body_en: "The Battle of Baghdad took place three weeks after the U.S. invasion of Iraq. It resulted in the removal of Saddam Hussein from office and was followed by an extended period of American occupation.",
    body_es: "Spanish body",
  ...
  },
  {
    ...
    time_en: "May 1, 2003",
    time_es: "",
    body_en: `President Bush famously announces the end of major combat operations in Iraq in front of a banner that read “Mission Accomplished.”`,
    body_es: "Spanish body",
    caption_en: "The USS Abraham Lincoln returning to port carrying the infamous “Mission Accomplished” banner.",
    caption_es: "Spanish caption",
  ...
  },
  {
    ...
    time_en: "Dec 13, 2003",
    time_es: "",
    body_en: "Hussein is captured during Operation Red Dawn and later stands trial for crimes against humanity.",
    body_es: "Spanish body",
    caption_en: "Iraqi dictator Saddam Hussein pinned to the ground during his capture in Tikrit.",
    caption_es: "Spanish caption",
  ...
  },
  {
    ...
    time_en: "Jan 10, 2007",
    time_es: "",
    body_en: `President Bush ordered an increase of 30,000 troops to Iraq known as “The Surge.” The Surge increased violence temporarily, but ultimately eased the chaos in and around Baghdad during 2007.`,
    body_es: "Spanish body",
    caption_en: "President Bush makes a statement to reporters on the war in Iraq in May 2007.",
    caption_es: "Spanish caption",
    image: "Joint_Chiefs_of_Staff_May_2007_Public_Domain.jpg",
    rank: 3,
    link: ""
  },
  {
    title_en: `Polls Reveal American Support for Iraq War waning`,
    title_es: "Spanish title",
    time_en: "Feb 21, 2008",
    time_es: "",
    body_en: `Five years after the beginning of the Iraq War, 54% of Americans predict that the war will be remembered as a failure and 53% of Americans believe that the Bush administration misled the American public about WMDs in Iraq.`,
    body_es: "Spanish body",
    caption_en: "Protestors march to the Pentagon in opposition to the continuation of the war in Iraq.",
    caption_es: "Spanish caption",
  ...
  },
  {
    ...
    time_en: "Nov 4, 2008",
    time_es: "",
    body_en: `Democratic Senator Barack Obama of Illinois defeated Republican Senator John McCain of Arizona. Ending the Iraq War was central to Obama’s campaign.`,
    body_es: "Spanish body",
    caption_en: "Senator Obama speaks with a soldier stationed in Iraq.",
    caption_es: "Spanish caption",
  ...
  },
  {
    ...
    time_en: "May 2, 2011",
    time_es: "",
    body_en: `The CIA-led mission known as “Operation Neptune Spear,” resulted in the death of Osama bin Laden, ending a nearly 10-year search.`,
    body_es: "Spanish body",
    caption_en: "Members of the Obama administration track the mission that led to the killing of bin Laden.",
    caption_es: "Spanish caption",
  ...
  },
  {
    ...
    time_en: "Dec 18, 2011",
    time_es: "",
    body_en: `The last 500 soldiers leave Iraq, signaling the formal end of the Iraq War. American troops would return to Iraq in 2014 to combat the progression of ISIS.`,
    body_es: "Spanish body",
    caption_en: "The last U.S. convoy crossing the border into Kuwait from Iraq.",
    caption_es: "Spanish caption",
  ...
  },
  {
    ...
    time_en: "Nov 8, 2016",
    time_es: "",
    body_en: `Trump defeats Democratic candidate Secretary Hillary Clinton. As a candidate, Trump criticized the conflict in Afghanistan and pledged to bring troops home during his presidency.`,
    body_es: "Spanish body",
    caption_en: "Candidate Trump and running mate Mike Pence at the Republican National Convention in 2016.",
    caption_es: "Spanish caption",
  ...
  },
  {
    ...
    time_en: "Feb 29, 2020",
    time_es: "",
    body_en: `The Doha Agreement requires the withdrawal of all American and NATO troops from Afghanistan. In exchange, the Taliban pledge to prevent al-Qaeda from operating in areas under Taliban control.`,
    body_es: "Spanish body",
    caption_en: "U.S. representative Zalmay Khalilzad (left) and Taliban representative Abdul Ghani Baradar (right) sign the Doha Agreement.",
    caption_es: "Spanish caption",
  ...
  },
  {
    ...
    time_en: "Jan 20, 2021",
    time_es: "",
    body_en: `Biden defeated sitting president Donald Trump for the presidency. During his campaign, Biden fiercely criticized Trump’s record in the Middle East, referring to him as “a complete failure as Commander in Chief.”`,
    body_es: "Spanish body",
    caption_en: "Joe Biden takes the Oath of Office, becoming the 46th President of the United States.",
    caption_es: "Spanish caption",
  ...
  },
  {
    ...
    time_en: "May 5, 2021",
    time_es: "",
    body_en: `The Taliban begins capturing territory in Afghanistan. In the first three months of the offensive, they make significant advances.`,
    body_es: "Spanish body",
    caption_en: "Taliban fighters in Kabul",
    caption_es: "Spanish caption",
  ...
  },
  {
    ...
    time_en: "July 5, 2021",
    time_es: "",
    body_en: `As part of America’s phased withdrawal, the U.S. handed over Bagram Airfield to the Afghan military. This came as a surprise to the new Afghan commander, who reportedly learned of the American departure two hours after it happened.`,
    body_es: "Spanish body",
    caption_en: "Bagram Airfield, Afghanistan in 2015.",
    caption_es: "Spanish caption",
    image: "F-16_takes_off_at_Bagram_Public_Domain.jpg",
    credit: "",
    rank: 4,
    link: ""
  },
  {
    title_en: `The Taliban Retakes Afghanistan`,
    title_es: "Spanish title",
    time_en: "August 15, 2021",
    time_es: "",
    body_en: `After a three-month siege, Kabul, the capital of Afghanistan, falls to the Taliban on August 15, 2021. Later the same day, Afghan and Indian news reports claim that Afghan President Ashraf Ghani evacuated the country.`,
    body_es: "Spanish body",
    caption_en: "Afghan citizens desperately trying to escape Afghanistan after the Taliban retook Kabul.",
    caption_es: "Spanish caption",
